...
export function getTrainers(centerId: string, centerType: string): Trainer[] {
  const trainers: Record<string, Trainer[]> = {
    gym: [
      { id: `${centerId}-t1`, name: 'Bhupendra Singh', role: 'personal', photo: TRAINER_PHOTOS[0],
        specialization: 'In-depth Muscle Anatomy, Body Transformation',
        experience: '8 years', certifications: ['ACE Certified Personal Trainer', 'ISSA Nutrition Specialist'],
        rating: 4.9, sessions: 1200, fee: 800, available: ['Morning', 'Evening'] },
      { id: `${centerId}-t2`, name: 'Hanuman Fitness Expert', role: 'personal', photo: TRAINER_PHOTOS[1],
        specialization: 'Bodybuilding, Bench Press, Strength Training',
        experience: '15 years', certifications: ['Certified Strength Coach'],
    ...
    yoga: [
      { id: `${centerId}-t1`, name: 'Karan Singh', role: 'personal', photo: TRAINER_PHOTOS[0],
        specialization: 'Traditional Yoga, Pilates, Specialized Training',
        experience: '12 years', certifications: ['RYT-500 Yoga Alliance', 'Yoga Therapy Certification'],
        rating: 4.9, sessions: 3000, fee: 600, available: ['Morning', 'Evening'] },
      { id: `${centerId}-t2`, name: 'Menka', role: 'personal', photo: TRAINER_PHOTOS[1],
        specialization: 'Therapeutic Yoga, Beginner Classes',
        experience: '7 years', certifications: ['RYT-200', 'Yoga Therapy Certified'],
        rating: 5.0, sessions: 1800, fee: 500, available: ['Morning', 'Afternoon'] },
    ...
    zumba: [
      { id: `${centerId}-t1`, name: 'Sunil Sir', role: 'personal', photo: TRAINER_PHOTOS[1],
        specialization: 'Zumba, Dance Fitness, Hula Hoop, Kids fitness',
        experience: '6 years', certifications: ['Licensed Zumba Instructor', 'Dance Therapy'],
        rating: 4.9, sessions: 1600, fee: 500, available: ['Morning', 'Evening'] },
      { id: `${centerId}-t2`, name: 'Shikha Kumbhat', role: 'common', photo: TRAINER_PHOTOS[3],
        specialization: 'Zumba and dance fitness',
        experience: '4 years', certifications: ['Zumba B1 Licensed', 'Aerobics Instructor'],
        rating: 4.8, sessions: 900, fee: 0, available: ['Morning', 'Afternoon', 'Evening'] },
    ],
    dance: [
      { id: `${centerId}-t1`, name: 'Deepak Sir', role: 'personal', photo: TRAINER_PHOTOS[2],
        specialization: 'Zumba and various dance forms',
        experience: '8 years', certifications: ['Certified Dance Instructor'],
        rating: 4.8, sessions: 1100, fee: 600, available: ['Morning', 'Evening'] },
    ],
    swimming: [
      { id: `${centerId}-t1`, name: 'The Capital Sports Team', role: 'personal', photo: TRAINER_PHOTOS[0],
        specialization: 'Olympic-sized pool training, All age groups',
        experience: '10 years', certifications: ['Certified Swim Coach'],
        rating: 4.9, sessions: 1500, fee: 800, available: ['Morning', 'Evening'] },
    ],
  }
  // Default fallback
