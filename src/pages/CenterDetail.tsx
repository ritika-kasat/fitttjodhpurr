...
const FALLBACK_CENTERS: any[] = [
  { id: '1', name: 'Equinox Fitness', type: 'gym', specialization: 'Body transformation, Personal training, Weight loss',
    address: 'Residency Road, Near Circuit House', area: 'Ratanada', rating: 4.8, total_reviews: 450,
    amenities: ["AC","Parking","Locker","Shower","Diet Counseling","WiFi"],
  ...
  { id: '2', name: 'Fitbox Fitness Studio', type: 'gym', specialization: 'Group classes, Strength training, Functional fitness',
    address: 'Paota Main Road, B Road', area: 'Paota', rating: 4.5, total_reviews: 320,
    amenities: ["AC","Locker","Steam Bath","Personal Training"],
  ...
  { id: '3', name: 'Metalix Gym', type: 'gym', specialization: 'Bodybuilding, Powerlifting, Calisthenics',
    address: 'Sardarpura 4th Road, Near Police Station', area: 'Sardarpura', rating: 4.7, total_reviews: 510,
    amenities: ["AC","Parking","Supplement Store","Locker"],
  ...
  { id: '4', name: 'CrossFit Fitness Center', type: 'crossfit', specialization: 'High-intensity functional training, Olympic lifting',
    address: 'Pal Road, Near Pal Overbridge', area: 'Pal', rating: 4.9, total_reviews: 150,
    amenities: ["Parking","Outdoor Area","Juice Bar","Pull-up Rigs"],
  ...
  { id: '5', name: 'Sky Fit Gym', type: 'zumba', specialization: 'Zumba, Yoga, Dance fitness, Aerobics',
    address: 'Mandore Road, Near Mandore Garden', area: 'Mandore', rating: 4.2, total_reviews: 190,
    amenities: ["AC","Changing Room","Sound System","Dance Floor"],
  ...
  { id: '6', name: 'Rishi Fitness Centre', type: 'yoga', specialization: 'Classical Yoga, Meditation, Pranayama',
    address: 'City Center, Sojati Gate', area: 'City', rating: 4.6, total_reviews: 210,
    amenities: ["Meditation Hall","Parking","Yoga Props"],
  ...
  { id: '7', name: 'Trident Fitness', type: 'mma', specialization: 'Mixed Martial Arts, Kickboxing, Boxing',
    address: 'Circuit House Road, Rai Ka Bagh', area: 'Rai Ka Bagh', rating: 4.8, total_reviews: 120,
    amenities: ["MMA Ring","Punching Bags","Shower","Lockers"],
  ...
  { id: '8', name: 'Core Pilates Studio', type: 'pilates', specialization: 'Reformer Pilates, Mat Pilates, Flexibility',
    address: 'Residency Road, Near HDFC Bank', area: 'Ratanada', rating: 4.9, total_reviews: 180,
    amenities: ["AC","Pilates Reformers","Locker","Mats provided"],
  ...
  { id: '9', name: 'Blue City Aquatics', type: 'swimming', specialization: 'Indoor Swimming, Aqua Aerobics, Coaching',
    address: 'Pal Road, Near Stadium', area: 'Pal', rating: 4.6, total_reviews: 245,
    amenities: ["Olympic Pool","Shower","Lockers","Lifeguard"],
  ...
  { id: '10', name: 'Rhythm Dance Academy', type: 'dance', specialization: 'Hip-Hop, Bollywood, Contemporary Dance',
    address: 'Sardarpura 2nd Road', area: 'Sardarpura', rating: 4.7, total_reviews: 310,
    amenities: ["Wooden Floor","Mirrors","Sound System","AC"],
  ...
  { id: '11', name: 'Jodhpur Cycling Club', type: 'cycling', specialization: 'Indoor Spin Classes, Cardio, Endurance',
    address: 'Paota B Road, Near SBI', area: 'Paota', rating: 4.8, total_reviews: 165,
    amenities: ["Spin Bikes","AC","Locker","Juice Bar"],
  ...
  { id: '12', name: 'Zen Meditation Center', type: 'meditation', specialization: 'Guided Meditation, Mindfulness, Healing',
    address: 'Mandore Road, Near Garden', area: 'Mandore', rating: 4.9, total_reviews: 88,
    amenities: ["Silent Zone","Garden","Cushions","Tea Room"],
...
function generateFallbackPlans(centerId: string, centerName: string, centerType: string) {
  const basePrice: Record<string, number> = {
    crossfit: 1299, mma: 1199, yoga: 799, zumba: 699,
    pilates: 999, swimming: 1099, dance: 799, cycling: 899, meditation: 599, gym: 899,
  }
  const bp = basePrice[centerType] || 899
  return [
    { id: `${centerId}-allm`, name: 'FitJodhpur All-Access Monthly', plan_type: 'all_access', center_id: null,
      duration_days: 30, price_inr: 1499, is_featured: false,
    ...
    { id: `${centerId}-allq`, name: 'FitJodhpur All-Access Quarterly', plan_type: 'all_access', center_id: null,
      duration_days: 90, price_inr: 3999, is_featured: true,
  ...
  useEffect(() => {
    ...
    const fetchData = async () => {
      ...
      if (usedCenter) {
        ...
        setPlans(p && p.length > 0 ? p : generateFallbackPlans(id, usedCenter.name, usedCenter.type))
      }
      setLoading(false)
    }
    fetchData()
